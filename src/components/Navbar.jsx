        ...
        <nav className="navbarNav">
            <ul className="navbarListItems">
                ...
                <li className="navbarListItem" onClick={()=> navigate('/') }>
                    <ExploreIcon fill={pathMathRoute("/") ? "#00cc66" : "#8f8f8f"} width="36px" height="36px"/>
                ...
                onClick={() => navigate("/offers")}>
                    <OfferIcon fill={pathMathRoute("/offers") ? "#00cc66" : "#8f8f8f"} width="36px" height="36px"/>
                    <p className={pathMathRoute("/offers") ? "navbarListItemNameActive" : "navbarListItemName"}>Offers</p>
                </li>

                {/* profile */}
                <li className="navbarListItem" onClick={() => navigate("/profile")}>
                    <PersonOutlineIcon fill={pathMathRoute("/profile") ? "#00cc66" : "#8f8f8f"} width="36px" height="36px"/>
